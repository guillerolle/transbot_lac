...
# Recursively include all files in launch/ and rviz/ preserving subfolders
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'joint_teleop_joy = transbot_teleop.joint_teleop_joy:main'
        ],
    },
)
